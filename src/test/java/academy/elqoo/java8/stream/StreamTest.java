...
public class StreamTest {
  ...
  public void shouldReturnDistinctLetters() {
    ...
    assertThat(result, equalTo(Arrays.asList("H", "o", "m", "e", "r", " ", "S", "i", "p", "s", "n", "M", "a", "g", "B", "t",
        "K", "c", "k")));
  }
  ...
  @Test
  public void shouldCollectToStringParallel() {
    String sample = "Working with Java8 Streams";
    String result = sample.chars()
        .mapToObj(a -> ((char) a))
        .parallel()
  ...
  @Test
  public void shouldGetMultiplicationUsingReduce() {
    Integer[] array = {1,3,4,-1};
    int result = Stream8.getMultiplicationUsingReduce(Arrays.asList(array));
    assertThat(-12, equalTo(result));
  }
}
